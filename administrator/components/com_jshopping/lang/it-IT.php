...
define("_JSHOP_STORE_COMPANY", "Nome società");
define("_JSHOP_STORE_URL", "URL");
define("_JSHOP_STORE_ADRESS", "Indirizzo");
define("_JSHOP_STORE_CITY", "Città");
...
define("_JSHOP_BENEF_BANK", "Banca di appoggio");
define("_JSHOP_BENEF_BANK_INFO", "Informazioni banca di appoggio");
...
define("_JSHOP_BENEF_BANK_NAME", "Nome banca di appoggio");
...
define("_JSHOP_CATEGORY_DELETED", "La Categoria %s è stata eliminata");
define("_JSHOP_PRODUCT_DELETED", "Il Prodotto con ID %s è stato eliminato");
define("_JSHOP_CATEGORY_NO_DELETED", "La Categoria %s non può essere eliminata. Non è vuota");
...
define("_JSHOP_MANUFACTURER_DELETED", "Il Produttore con ID %s è stato cancellato");
...
define("_JSHOP_CURRENCY_DELETED", "La valuta è stata cancellata");
...
define("_JSHOP_TAX_NO_DELETED", "La tassa %s non può essere cancellata, perchè esistono prodotti che utilizzano questa tassa");
define("_JSHOP_TAX_DELETED", "La tassa %s è stata cancellata.");
define("_JSHOP_TAXES", "Tasse");
define("_JSHOP_TAX", "Incl. tassa");
define("_JSHOP_EXTENDED_RULE_TAX", "Imposta regole delle Tasse");
define("_JSHOP_FIRMA_TAX", "Tassa sul reddito della Società");
...
// Messages
define("_JSHOP_WRITE_PRODUCTS_ROW", "Inserisci quantità di prodotti per riga");
define("_JSHOP_WRITE_PRODUCTS_PAGE", "Inserisci quantità di prodotti per pagina");
define("_JSHOP_WRITE_TAX_NO_VALID", "Il valore della tassa non è valido");
...
define("_JSHOP_ERROR_CREATING_THUMBNAIL", "Errore nella creazione dell'anteprima");
define("_JSHOP_ERROR_DELETE_LANGUAGE", "Errore nell'eliminazione della lingua");
define("_JSHOP_CURRENCY_ERROR_DELETED", "Errore nell'eliminazione della valuta");
define("_JSHOP_COUPON_ERROR_DELETED", "Errore nell'eliminazione del buono sconto");
define("_JSHOP_ERROR_PAYMENT_DELETED", "Errore nell'eliminazione del metodo di pagamento");
define("_JSHOP_ERROR_SHIPPING_DELETED", "Errore nell'eliminazione del metodo di spedizione");
define("_JSHOP_ORDER_STATUS_ERROR_DELETED", "Errore nell'eliminazione dello stato dell'ordine");
define("_JSHOP_ERROR_COUPON_EXIST", "Questo buono sconto esiste già");
define("_JSHOP_ERROR_CREATE_THUMBAIL", "Errore nella creazione delle thumbails");
define("_JSHOP_ERROR_ALIAS_ALREADY_EXIST", "Errore. Alias già esistente");
define("_JSHOP_PASSWORD_DONT_MATCH", "La Password non corrisponde");
define("_JSHOP_CERTAIN_METHODS_DELIVERY_NOT_SET_PRICE", "Per certi metodi di spedizione il prezzo non è impostato");
define("_JSHOP_YOU_NOT_SET_PRICE", "Non è stato specificato un prezzo");
...
define("_JSHOP_QUANTITY_PRODUCT", "Disponibilità");
define("_JSHOP_INFO_PLEASE_EDIT_AMOUNT_FOR_ATTRIBUTE", "Cambiare il numero di prodotti negli attributi");
define("_JSHOP_AVILABILITY_PRODUCT", "Disponibilità prodotto");
...
define("_JSHOP_PRODUCT_QUANTITY_START", "Quantità di partenza");
define("_JSHOP_PRODUCT_QUANTITY_FINISH", "Quantità massima");
define("_JSHOP_PRODUCT_ADD_PRICE_ADD", "Aggiungi prezzo");
define("_JSHOP_OLD_PRICE", "Vecchio prezzo");
define("_JSHOP_PRODUCT_BUY_PRICE", "Prezzo d'ordine");
...
define("_JSHOP_INFO_DEFAULT_LANGUAGE", "Questa lingua sarà usata per ogni configurazione della lingua nel negozio");
...
define("_JSHOP_IMAGE_CATEGORY_HEIGHT", "Altezza per l'anteprima della categoria");
define("_JSHOP_IMAGE_CATEGORY_WIDTH", "Larghezza per l'anteprima della categoria");
define("_JSHOP_IMAGE_PRODUCT_THUMB_HEIGHT", "Altezza per l'anteprima del prodotto");
define("_JSHOP_IMAGE_PRODUCT_THUMB_WIDTH", "Larghezza per l'anteprima del prodotto");
define("_JSHOP_IMAGE_PRODUCT_FULL_HEIGHT", "Altezza per l'immagine del prodotto");
define("_JSHOP_IMAGE_PRODUCT_FULL_WIDTH", "Larghezza per l'immagine del prodotto");
...
define("_JSHOP_DECIMAL_COUNT_DESCRIPTION", "Quantità di decimali visualizzati (può essere 0)<br /><b>Esegue l'arrotondamento, se ha un valore diverso dal numero di decimali</b>");
...
define("_JSHOP_THOUSAND_SEPARATOR_DESCRIPTION", "Carattere usato per separare le migliaia (può essere vuoto)");
...
define("_JSHOP_NEXT_ORDER_NUMBER", "Il prossimo ordine inzierà dal numero");
...
define("_JSHOP_CLIENT_ALLOW_CANCEL_ORDER", "Il cliente può cancellare l'ordine");
...
define("_JSHOP_COUPON_VALUE_DESCRIPTION", "L'importo è una percentuale o un totale?");
define("_JSHOP_COUPON_DELETED", "Buono sconto cancellato");
define("_JSHOP_COUPON_ERROR_EXIST", "Questo buono sconto esiste già");
...
define("_JSHOP_DELETE_PAYMENT_YES", "Sei sicuro di voler eliminare l'oggetto?");
...
// Paypal
define("_JSHOP_PAYPAL_TESTMODE_DESCRIPTION", "Per provare l'account PayPal");
...
define("_JSHOP_PAYPAL_TRANSACTION_END_DESCRIPTION", "Seleziona lo stato per cui l'ordine attuale è impostato, se l'IPN PayPal ha avuto successo.");
define("_JSHOP_PAYPAL_TRANSACTION_PENDING_DESCRIPTION", "Stato dell'ordine per i pagamenti non completati");
...
define("_JSHOP_NOT_SET_PRICE", "Non è stato fissato un prezzo");
...
define("_JSHOP_ATTRIBUT_DELETED", "L'attributo è stato cancellato");
...
define("_JSHOP_ATTRIBUT_VALUE_DELETED", "Il valore dell'attributo è stato cancellato");
...
// Order Status
define("_JSHOP_LIST_ORDER_STATUSS", "Lista stati d'ordine");
define("_JSHOP_ORDER_STATUS", "Stato dell'ordine");
define("_JSHOP_NEW_ORDER_STATUS", "Nuovo stato d'ordine");
define("_JSHOP_EDIT_ORDER_STATUS", "Modifica stato d'ordine");
define("_JSHOP_ORDER_STATUS_DELETED", "Stato d'ordine cancellato");
define("_JSHOP_ORDER_STATUS_CHANGED", "Lo stato d'ordine è stato cambiato con successo");
...
define("_JSHOP_NOTIFY_USER", "Invia notifica all'utente");
...
define("_JSHOP_PANEL_UNITS_MEASURE", "Unità di misura");
define("_JSHOP_PANEL_PRODUCT_LABELS", "Etichette Prodotto");
define("_JSHOP_PANEL_PRODUCT_EXTRA_FIELDS", "Caratteristiche Prodotto");

//Usergroups
define("_JSHOP_USERGROUP_DELETED", "Gruppo utenti %s è stato cancellato");
define("_JSHOP_USERGROUP_NOT_DELETED", "Gruppo utenti %s non può essere cancellato. Non è vuoto");
...
define("_JSHOP_ORDER_DELETED_ID", "L'ordine ID %s è stato cancellato"); 
...
define("_JSHOP_ATTRIBUTE_EXIST", "Errore. L'attributo esiste già");
define("_JSHOP_INC_TAX", "incl. IVA");
define("_JSHOP_PLUS_TAX", "ppiù IVA");
...
define("_JSHOP_EMAIL_ADMIN_INFO", "L'ordine sarà spedito a questo indirizzo");
...
define("_JSHOP_DEFAULT_LANG_FOR_COPY_INFO", 'Il testo da questa lingua sarà copiato nei nuovi campi della lingua che verrano creati. <a href="index.php?option=com_jshopping&controller=config&task=general">Modifica</a>');
...
define("_JSHOP_DELIVERY_TIME_DELETED", "Il tempo di spedizione è stato cancellato");
...
define("_JSHOP_ITEM_DELETED", "L'oggetto è stato cancellato");
...
define("_JSHOP_WEIGHT_VOLUME_UNITS", "peso / volume / unità");
define("_JSHOP_BASIC_PRICE", "Prezzo base");
define("_JSHOP_BASIC_QTY", "Quantità base");

define("_JSHOP_UNIT_MEASURE", "Unità di misura");
define("_JSHOP_LIST_UNITS_MEASURE", "Unità di misura");
define("_JSHOP_UNITS_MEASURE_NEW", "Nuova unità di misura");
define("_JSHOP_UNITS_MEASURE_EDIT", "Modifica unità di misura");
...
define("_JSHOP_FIELD_CITY", "Città");
...
define("_JSHOP_UPLOAD_FILE_VIA_FTP", "Nome File. E' necessario il caricamento via FTP");
...
define('_JSHOP_VERSION','Versione');
define('_JSHOP_LOAD','Caricamento');

define('_JSHOP_OC', 'Altre configurazioni');
define('_JSHOP_OC_show_insert_code_in_product_video', 'Inserisci codice nel video prodotto');
define('_JSHOP_OC_cart_back_to_shop', 'Torna allo shop (link carrello)');
define('_JSHOP_OC_cart_back_to_shop_INFO', 'prodotto / lista / negozio');
define('_JSHOP_OC_product_button_back_use_end_list', 'Tasto indietro nel prodotto(usa end list)');
define('_JSHOP_OC_display_tax_id_in_pdf', 'Mostra ID tasse nel PDF');
define('_JSHOP_OC_image_quality', 'Qualità immagine');
define('_JSHOP_OC_image_fill_color', 'Riempimento immagine');
define('_JSHOP_OC_product_price_qty_discount', 'Sconto quantità prodotto');
define('_JSHOP_OC_product_price_qty_discount_INFO', '1 - prezzo, 2 - percentuale');
define('_JSHOP_OC_rating_starparts', 'Suddivisioni stelline valutazione');
define('_JSHOP_OC_rating_starparts_INFO', 'la stella è divisa in {2} parti');
define('_JSHOP_OC_show_list_price_shipping_weight', 'Mostra prezzi secondo peso della spedizione');
define('_JSHOP_OC_product_price_precision', 'Precisione prezzi prodotto');
define('_JSHOP_OC_cart_decimal_qty_precision', 'Precisione dei decimali nel carrello');
define('_JSHOP_OC_default_frontend_currency', 'ID valuta di default nel frontend');
define('_JSHOP_OC_product_file_upload_via_ftp', 'Upload file prodotto(via ftp)');
define('_JSHOP_OC_product_file_upload_via_ftp_INFO', '0 - upload file, 1- definisci nome file, 2- {0,1}');
define('_JSHOP_OC_product_file_upload_count', 'Conteggio file in upload');
define('_JSHOP_OC_product_image_upload_count', 'Conteggio immagini in upload');
define('_JSHOP_OC_product_video_upload_count', 'Conteggio video in upload');
define('_JSHOP_OC_max_number_download_sale_file', 'Totale massimo file uploadabili per prodotto');
define('_JSHOP_OC_max_number_download_sale_file_INFO', '0 - illimitato');
define('_JSHOP_OC_max_day_download_sale_file', 'Numero totale di file uploadabili al giorno');
define('_JSHOP_OC_max_day_download_sale_file_INFO', '0 - illimitato');
define('_JSHOP_OC_order_display_new_digital_products', 'Mostra nuovi prodotti digitali (ordine)');
define('_JSHOP_OC_display_user_groups_info', 'Mostra info sui gruppi di utenti');
define('_JSHOP_OC_display_user_group', 'Mostra gruppi di utenti');
define('_JSHOP_OC_display_delivery_time_for_product_in_order_mail', 'Mostra tempi di evasione ordine (e-mail)');
define('_JSHOP_OC_load_jquery', 'Caricamento jQuery');
define('_JSHOP_OC_load_jquery_version', 'Versione jQuery');
define('_JSHOP_OC_load_jquery_lightbox', 'Caricamento Lightbox');
define('_JSHOP_OC_load_css', 'Caricamento css');
define('_JSHOP_OC_load_javascript','Caricamento javascript');

define('_JSHOP_SHOW_EXTRA_FIELDS_CART','Mostra caratteristiche nel carrello');
define('_JSHOP_OVERRIDING_ADDRESSES','Sovrascrivi indirizzi');
define('_JSHOP_DELIVERY_ORDER_DEPENDS_DELIVERY_PRODUCT',"La consegna dell'ordine dipende dai tempi di consegna del prodotto");
define('_JSHOP_DAYS','Giorni');
define('_JSHOP_ORDER_FINISH', 'Conferma Ordine');
define('_JSHOP_INSERT_CODE', 'Inserisci Codice');
define('_JSHOP_UPDATE_ARE_AVAILABLE', 'Aggiornamenti di %s sono disponibili!');
